...
function GetExhibitionParticipantsAll($db, $log, $id, $filter, $dbw)
{
	...
	$stmt = $db->prepare("SELECT u.id, u.fullname as pełna_nazwa, u.plec, u.data_ur as data_urodzenia, r.rasa, r.breed, r.grupa, m.masc, u.klasa, u.data_zg as data_zgłoszenia, u.tytul,
