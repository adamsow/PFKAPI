...
include_once('Service/Commons/CommonService.php');
...
function GetExhibitionParticipantsAll($db, $log, $id, $filter, $dbw)
{
	...
	$stmt = $db->prepare("SELECT u.id, u.fullname as pe�na_nazwa, u.plec, u.data_ur as data_urodzenia, r.rasa, r.breed, r.grupa, m.masc, u.klasa, u.data_zg as data_zg�oszenia, u.tytul,
						u.wyszkolenie, u.nr_rod as nr_rodowodu, u.oznakowanie, u.sire as ojciec, u.dam as matka, u.hod_imie as imi�_hodowcy, u.hod_nazwisko as nazwisko_hodowcy,
						u.imie as imie_w�a�ciciela, u.nazwisko as nazwisko_w�a�ciciela, u.ulica, u.kod, u.miejscowosc as miejscowo��, u.region, u.panstwo as pa�stwo, u.tel, u.email, 
